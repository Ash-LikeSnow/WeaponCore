            ...
            {
                {
                    MyLanguagesEnum.English, new Dictionary<string, string>
                    {
                        ...
                        { $"ShowPFlagsTitle", "Show Projectile Type Settings" },
                        { $"ShowPFlagsTooltip", "Toggles whether the list of toggleable projectile flags (read: projectile sub-types) are shown" },
                        { $"PFlagsAndToggleTitle", "Use And Behavior" },
                        { $"PFlagsAndToggleTooltip", "When on, only targets projectiles which have all of the listed flags. When off, targets projectiles with atleast one of the listed flags." },
                        { $"PFlagsListTitle", "Target Projectile Flags" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.IsDumb}", "Dumb" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.IsSmart}", "Smart" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.IsDrone}", "Drones" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.IsMine}", "Mines" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.IsTravelTo}", "Travel To" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.NoEwar}", "No EWAR" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.EwarEffect}", "Effect Based EWAR" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.EwarField}", "Field Based EWAR" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.NonExplosive}", "Non Explosive" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.BBHExplosive}", "By Block Hit Explosive" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.EOLExplosive}", "End of Life Explosive" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.NoFragments}", "No Fragments" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.HasFragments}", "Has Fragments" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.AffectedByAntiSmarts}", "Affected by Countermeasures" },
                        { $"SPF_{WeaponDefinition.ProjectileFlags.IgnoresAntiSmarts}", "Ignores Countermeasures" },
                    }
                },
               {
                ...
                },
                {
                    MyLanguagesEnum.ChineseChina, new Dictionary<string, string>
                    {
                        ...
                        { "TerminalBurstDelayTooltip", "每ticks（1/60秒）的射击间隔" },
                        ...
                        { "TerminalAdvancedTooltip", "这会启用高级 WeaponCore UI 功能与选项" },
                        ...
                        { "WeaponInfoServerModdedLine2", "向服务器管理员报告本错误！" },
